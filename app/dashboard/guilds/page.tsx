...
export default function GuildShowcasePage() {
	...
	const fetchShowcase = async (showcase_id: string) => {
		...
		if (data) {
			...
			setSelectedShowcase(data as typeof selectedShowcase);
		}
	};
				...
				<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-2">
					...
					<div className="flex flex-wrap gap-2">
						...
						<Dialog
							...
							onOpenChange={setIsGuildDialogOpen}
						>
							...
							{guild.guild_showcase?.map(
								(showcase: {
									...
									showcase && (
										...
										>
											{showcases[showcase.showcase_id]
												?.showcase_name ||
												"click to reveal"}
										</Button>
									)
			...
			<div className="w-full md:w-1/2 lg:w-2/3">
				{selectedShowcase ? (
					<Card>
						<CardHeader>
							<CardTitle>
								{selectedShowcase.showcase_name}
							</CardTitle>
						</CardHeader>
							...
							<div className="bg-gray-50 p-4 rounded-lg">
								...
								<div className="space-y-2">
									<p>
										...
										{selectedShowcase.project?.title}
									</p>
									<p>
										<span className="font-medium">
											Description:
										</span>{" "}
										{selectedShowcase.project?.description}
									</p>
									<p>
										<span className="font-medium">
											Status:
										</span>{" "}
										{selectedShowcase.project?.progress}
										%{" "}
									</p>
								</div>
							</div>
